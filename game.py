...
run_left = pygame.image.load('Sprites/andandole (1).png')
...
while running:
    ...
    if moving:
        if last_direction == 'left':
            ...
            draw_player(player_x, player_y, player_run_left)
        ...
        # elif last_direction == 'left':draw_player(player_x, player_y, player_atk_left)
        elif last_direction == 'right':
